...
@section('content-header')
    <h1>
        {{ trans('voucher::vouchers.title.vouchers') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('voucher::vouchers.title.vouchers') }}</li>
    </ol>
@stop
        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.voucher.voucher.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('voucher::vouchers.button.create voucher') }}
                    </a>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin.voucher.voucher.edit', [$voucher->id]) }}">
                                        {{ $voucher->created_at }}
                                    </a>
                                </td>
                                <td>
...
@section('shortcuts')
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd>{{ trans('voucher::vouchers.title.create voucher') }}</dd>
    </dl>
@stop
